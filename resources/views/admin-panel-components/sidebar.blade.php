                    ...
                    <div class="collapse {{ (request()->is(['category', 'permissions', 'roles', 'user', 'settings'])) ? 'show' : '' }}" id="base">
                        <ul class="nav nav-collapse">
                            ...
                            <li class="{{ (request()->is('permissions')) ? 'active' : '' }}">
                                <a href="{{ route('permissions') }}" class="waves-effect waves-block">
                            ...
                            <li class="{{ (request()->is('roles')) ? 'active' : '' }}">
                                <a href="{{ route('roles') }}" class="waves-effect waves-block">
                            ...
                            <li class="{{ (request()->is('user')) ? 'active' : '' }}">
                                <a href="{{ route('user') }}" class="waves-effect waves-block">
                            ...
                            <li class="{{ (request()->is('settings')) ? 'active' : '' }}">
                                <a href="{{ route('settings') }}" class="waves-effect waves-block">
